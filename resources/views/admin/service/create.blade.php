<form id="createServiceForm" action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="name" id="name" placeholder="{{ __('common.enter_service_name') }}">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="file" name="image" id="image" placeholder="{{ __('common.file_input') }}">
