<form id="editSkillForm" action="{{ route('skills.update', $skill->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="name" id="name" value="{{ $skill->name }}" placeholder="{{ __('common.enter_skill_name') }}">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="percent" id="percent" value="{{ $skill->percent }}" placeholder="{{ __('common.enter_experience_percent') }}">
