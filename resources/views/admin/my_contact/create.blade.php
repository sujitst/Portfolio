<form id="createMyContactForm" action="{{ route('my-contact.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="name" id="name" placeholder="{{ __('common.enter_social_name') }}">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="info" id="info" placeholder="{{ __('common.enter_social_info') }}">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="icon" id="icon" placeholder="{{ __('common.enter_social_icon_class') }}">
