<form id="editExperienceForm" action="{{ route('experience.update', $experience->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="exp_name" id="exp_name" value="{{ $experience->exp_name }}" placeholder="{{ __('common.enter_experience_name') }}">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                <div class="input_form">
                    ...
                    <input type="text" name="exp_date_time" value="{{ $experience->exp_date_time }}" id="exp_date_time" placeholder="{{ __('common.enter_experience_datetime') }}">
